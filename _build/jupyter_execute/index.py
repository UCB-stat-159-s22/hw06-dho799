...
# LIGO-specific utils.py (updated) 
...
for det in dets:
    ...
    plot_func(time, timemax, SNR, pcolor, eventname, det, plottype, tevent, strain_whitenbp, template_match, template_fft,datafreq, d_eff, freqs, data_psd, fs)
